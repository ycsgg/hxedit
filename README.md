...
- **Format inspector** — built-in parsing for ELF, PNG, ZIP, GZIP, GIF, TAR, and JPEG structures with field-level editing
...
| `:format elf\|png\|zip\|gzip\|gif\|tar\|jpeg` | Force a specific format |
...
- Supports ELF, PNG, ZIP, GZIP, GIF, TAR, and JPEG formats
