...
- **Format inspector** — built-in parsing for ELF, PNG, ZIP, GZIP, and TAR structures with field-level editing
...
| `:format elf\|png\|zip\|gzip\|tar` | Force a specific format |
...
- Supports ELF, PNG, ZIP, GZIP, and TAR formats
...
- Editable fields can be modified, but PNG/ZIP/GZIP/TAR edits show warnings since structure consistency is not automatically repaired
