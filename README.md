...
- **Format inspector** — built-in parsing for ELF, PNG, ZIP, and GZIP structures with field-level editing
...
| `:format elf\|png\|zip\|gzip` | Force a specific format |
...
- Supports ELF, PNG, ZIP, and GZIP formats
...
- Editable fields can be modified, but PNG/ZIP/GZIP edits show warnings since structure consistency is not automatically repaired
