...
| [`docs/macro-design.md`](docs/macro-design.md) | 宏 / 脚本执行层设计、选区语义、undo / batch 边界、TUI / headless 接入顺序 |
| [`docs/remote-editing-design.md`](docs/remote-editing-design.md) | Remote 文件编辑的 source 抽象、保存语义、冲突检测、实施阶段 |
